...
<body>
	...
	?>
		...
		<form id="form_insert_client_existant_salarie" action="insert_client_existant_salarie.php" method="post" autocomplete="on" onsubmit="return verifie_formulaire_salarie(this)">
