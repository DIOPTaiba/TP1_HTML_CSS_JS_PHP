...
<body>
	...
	<div class="choix_client">
		...
		<form id="saisie_id_client" action="recherche_client.php" method="POST" >
	...
	<form id="form_compte_non_salarie" action="insert_client_non_salarie.php" method="post" onsubmit="return verifie_formulaire_non_salarie(this)">
		...
		<fieldset>
			...
			<div>
				...
				<input type="date" id="date_inscription" name="date_inscription" placeholder="test" />
			</div>
			<div>
				<label for="type_client">Type client </label>
				<input type="text" id="type_client" name="type_client" placeholder="à mettre selon le client Sélectionné, à cacher" />
			</div>
			<div>
