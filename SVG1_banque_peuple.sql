...
INSERT INTO `clients` (`id_clients`, `adresse`, `telephone`, `email`, `date_inscription`, `type_client`, `id_responsable_compte`) VALUES
(1, 'aa', '123456789', '', '2020-07-03 12:45:20', 'non salarié', 1),
(2, 'bb', '123546789', '', '2020-07-03 12:46:53', 'salarié', 1),
(3, 'dkr', '123456789', '', '2020-07-03 12:48:18', 'moral', 1);
...
INSERT INTO `client_moral` (`id_client_moral`, `nom_entreprise`, `identifiant_entreprise`, `raison_social`, `id_clients`) VALUES
(1, 'ccc', 'okm', 'Simplon.CO', 1);
...
INSERT INTO `client_non_salarie` (`id_client_non_salarie`, `nom`, `prenom`, `carte_identite`, `id_clients`) VALUES
(1, 'aa', 'aa', '100', 1);
...
INSERT INTO `client_salarie` (`id_client_salarie`, `nom`, `prenom`, `carte_identite`, `profession`, `salaire`, `nom_employeur`, `adresse_entreprise`, `raison_social`, `identifiant_entreprise`, `id_clients`) VALUES
(1, 'bb', 'bb', '200', 'dev', 300000, 'okk', 'dkr', 'dkr', 's100', 1);
...
INSERT INTO `comptes` (`id_comptes`, `numero_compte`, `cle_rib`, `solde`, `date_ouverture`, `numero_agence`, `id_clients`) VALUES
(1, '1111', 11, 200000, '2020-07-03 12:45:20', 1, 1),
(2, '2222', 22, 250000, '2020-07-03 12:46:55', 1, 1),
(3, '3333', 33, 200000, '2020-07-03 12:48:18', 1, 1),
(4, '11112', 112, 11111, '2020-07-03 12:49:46', 1, 1),
(5, '22222', 222, 22222, '2020-07-03 12:50:25', 1, 1),
(6, '33333', 333, 33333, '2020-07-03 12:51:19', 1, 1);
...
INSERT INTO `compte_bloque` (`id_compte_bloque`, `frais_ouverture`, `montant_remuneration`, `duree_blocage`, `id_comptes`) VALUES
(1, 20000, 5000, 13, 1),
(2, 20000, 6000, 15, 1);
...
INSERT INTO `compte_courant` (`id_compte_courant`, `agios`, `id_comptes`) VALUES
(1, 1000, 2);
...
INSERT INTO `compte_epargne` (`id_compte_epargne`, `frais_ouverture`, `montant_remuneration`, `id_comptes`) VALUES
(1, 10000, 5000, 1);
...
INSERT INTO `etat_compte` (`id_etat_compte`, `etat_compte`, `date_changement_etat`, `id_comptes`) VALUES
(1, 'actif', '2020-07-03 12:45:20', 1),
(2, 'actif', '2020-07-03 12:46:56', 1),
(3, 'actif', '2020-07-03 12:48:18', 1),
(4, 'actif', '2020-07-03 12:49:46', 1),
(5, 'actif', '2020-07-03 12:50:25', 1),
(6, 'actif', '2020-07-03 12:51:19', 1);
...
--
ALTER TABLE `client_moral`
  MODIFY `id_client_moral` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `client_non_salarie`
--
ALTER TABLE `client_non_salarie`
  MODIFY `id_client_non_salarie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `client_salarie`
--
ALTER TABLE `client_salarie`
  MODIFY `id_client_salarie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `compte_bloque`
  MODIFY `id_compte_bloque` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `compte_courant`
--
ALTER TABLE `compte_courant`
  MODIFY `id_compte_courant` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `compte_epargne`
--
ALTER TABLE `compte_epargne`
  MODIFY `id_compte_epargne` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `etat_compte`
  MODIFY `id_etat_compte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
