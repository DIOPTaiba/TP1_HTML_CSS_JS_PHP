...
<body>
	...
	<div id="page_authentification">
		...
		<form id="formulaire_admin" action="authentification_admin.php" method="POST" onsubmit="return controle_champs_admin()">
			<fieldset>
		...
		<form id="formulaire_responsable" action="authentification_responsable.php" method="POST" onsubmit="return controle_champs_responsable()">
			<fieldset>
		...
		<form id="formulaire_caissiere" action="authentification_caissiere.php" method="POST" onsubmit="return controle_champs_caissiere()">
			<fieldset>
